...
@section('page_title')
    {{ __('b2b::app.admin.companies.view.title') }}
@stop
    ...
    <div class="content">
        <div class="page-header">
            <div class="page-title">
                <h1>
                    ...
                    {{ __('b2b::app.admin.companies.view.title') }} - {{ $company->name }}
                </h1>
            </div>
        ...
        <div class="page-content">
            <div class="form-container">
                <accordian title="{{ __('b2b::app.admin.companies.view.general-info') }}" :active="true">
                    <div slot="body">
                        <div class="control-group">
                            <label>{{ __('b2b::app.admin.companies.create.name') }}</label>
                            <div class="control">{{ $company->name }}</div>
                        </div>

                        <div class="control-group">
                            <label>{{ __('b2b::app.admin.companies.create.email') }}</label>
                            <div class="control">{{ $company->email }}</div>
                        </div>

                        @if($company->phone)
                            <div class="control-group">
                                <label>{{ __('b2b::app.admin.companies.create.phone') }}</label>
                        ...
                        @if($company->website)
                            <div class="control-group">
                                <label>{{ __('b2b::app.admin.companies.create.website') }}</label>
                        ...
                        @if($company->industry)
                            <div class="control-group">
                                <label>{{ __('b2b::app.admin.companies.create.industry') }}</label>
                        ...
                        @if($company->description)
                            <div class="control-group">
                                <label>{{ __('b2b::app.admin.companies.create.description') }}</label>
                                <div class="control">{{ $company->description }}</div>
                            </div>
                        @endif

                        <div class="control-group">
                            <label>{{ __('b2b::app.admin.companies.create.status') }}</label>
                            <div class="control">
                ...
                @if($company->address || $company->city || $company->state || $company->country || $company->postal_code)
                    <accordian title="{{ __('b2b::app.admin.companies.view.address-info') }}" :active="false">
                        <div slot="body">
                            @if($company->address)
                                <div class="control-group">
                                    <label>{{ __('b2b::app.admin.companies.create.address') }}</label>
                            ...
                            @if($company->city)
                                <div class="control-group">
                                    <label>{{ __('b2b::app.admin.companies.create.city') }}</label>
                            ...
                            @if($company->state)
                                <div class="control-group">
                                    <label>{{ __('b2b::app.admin.companies.create.state') }}</label>
                            ...
                            @if($company->country)
                                <div class="control-group">
                                    <label>{{ __('b2b::app.admin.companies.create.country') }}</label>
                            ...
                            @if($company->postal_code)
                                <div class="control-group">
                                    <label>{{ __('b2b::app.admin.companies.create.postal-code') }}</label>
                ...
                @if($company->contact_person || $company->contact_email || $company->contact_phone)
                    <accordian title="{{ __('b2b::app.admin.companies.view.contact-info') }}" :active="false">
                        <div slot="body">
                            @if($company->contact_person)
                                <div class="control-group">
                                    <label>{{ __('b2b::app.admin.companies.create.contact-person') }}</label>
                            ...
                            @if($company->contact_email)
                                <div class="control-group">
                                    <label>{{ __('b2b::app.admin.companies.create.contact-email') }}</label>
                            ...
                            @if($company->contact_phone)
                                <div class="control-group">
                                    <label>{{ __('b2b::app.admin.companies.create.contact-phone') }}</label>
