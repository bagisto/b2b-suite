<x-shop::layouts.account>
    <!-- Page Title -->
    <x-slot:title>
        @lang('b2b::app.shop.customers.account.quotes.title')
    </x-slot>

    <!-- Breadcrumbs -->
    @if ((core()->getConfigData('general.general.breadcrumbs.shop')))
        @section('breadcrumbs')
            <x-shop::breadcrumbs name="quotes" />
        @endSection
    @endif
    ...
    <div class="mx-4 flex-auto max-md:mx-6 max-sm:mx-4">
        ...
        {!! view_render_event('bagisto.shop.customers.account.quotes.list.before') !!}

        <x-shop::datagrid :src="route('shop.customers.account.quotes.index')" :isMultiRow="true">
            <!-- Header -->
                ...
                <template v-else>
                    <div class="b2b-dg-head b2b-datagrid-head">
                        <div
                            ...
                            v-for="(columnGroup, index) in [['quotation_number', 'name', 'status'], ['customer_name', 'created_at'], ['base_total', 'negotiated_total'], []]"
                        >
        ...
        {!! view_render_event('bagisto.shop.customers.account.quotes.list.after') !!}
    </div>
