    ...
    public function run(array $parameters = [])
    {
        ...
        $attributeGroups = [
            [
                ...
                'code' => 'general',
                'admin_name' => trans(
                    key: 'b2b::app.seeders.company-attribute-groups.general',
                ...
                'code' => 'address',
                'admin_name' => trans(
                    key: 'b2b::app.seeders.company-attribute-groups.address',
                    locale: $parameters['default_locale']
                ),
                'column' => 1,
                'is_user_defined' => 0,
                ...
                'admin_name' => trans(
                    key: 'b2b::app.seeders.company-attribute-groups.meta-description',
                    locale: $parameters['default_locale']
                ),
                'column' => 2,
                'is_user_defined' => 0,
                ...
                'code' => 'policies',
                'admin_name' => trans(
                    key: 'b2b::app.seeders.company-attribute-groups.policies',
                    locale: $parameters['default_locale']
                ),
                'column' => 1,
                'is_user_defined' => 0,
                ...
                'code' => 'social_links',
                'admin_name' => trans(
                    key: 'b2b::app.seeders.company-attribute-groups.social-links',
                    locale: $parameters['default_locale']
                ),
                'column' => 2,
                'is_user_defined' => 0,
        ...
        $translations = collect($attributeGroups)->flatMap(function ($group) use ($parameters) {
            return collect($parameters['locales'])->map(function ($locale) use ($group) {
                ...
                return [
                    ...
                    'locale' => $locale,
                    'name' => trans(
                        key: "b2b::app.seeders.company-attribute-groups.$translationKey",
                        locale: $locale
                    ),
                ];
            });
